...
-- Ce fichier contient un utilisateur par défaut pour que les articles soient rattachés à un auteur

-- Utilisateur par défaut
INSERT INTO `user` (name, email, password, roles) VALUES
('Admin', 'admin@symphonypress.local', '$2y$13$3GeWcKzNUl8g9IpQeQIGDuKZH.fFw1YfVXFLbvVqAY8A.jV6NrXgm', '["ROLE_ADMIN"]');
...
-- Articles (avec author_id = 1, l'utilisateur Admin)
